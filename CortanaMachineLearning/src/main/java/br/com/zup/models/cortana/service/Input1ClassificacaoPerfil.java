...
public class Input1ClassificacaoPerfil {
	...
	private Long valor_saldo_mes0;
	private Long valor_saldo_mes_1;
	...
	public Long getValor_saldo_mes0() {
		return valor_saldo_mes0;
	}
	public void setValor_saldo_mes0(Long valor_saldo_mes0) {
		this.valor_saldo_mes0 = valor_saldo_mes0;
	}
	public Long getValor_saldo_mes_1() {
		return valor_saldo_mes_1;
	}
	public void setValor_saldo_mes_1(Long valor_saldo_mes_1) {
		this.valor_saldo_mes_1 = valor_saldo_mes_1;
	}
	...
	public String toString() {
		return valor_saldo_mes0 + ";" + valor_saldo_mes_1 + ";" + valor_saldo_mes_2 + ";" + valor_saldo_mes_3 + ";"
				+ valor_saldo_mes_4 + ";" + valor_saldo_mes_5 + ";" + valor_saldo_mes_futuro + ";" + indentificador;
	}
