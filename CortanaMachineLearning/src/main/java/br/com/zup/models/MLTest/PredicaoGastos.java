package br.com.zup.models.MLTest;

import com.google.gson.Gson;

public class PredicaoGastos {
	...
	private Long valor_gasto_mesAtual;
	...
	public Long getValor_gasto_mesAtual() {
		return valor_gasto_mesAtual;
	}

	public PredicaoGastos() {
		super();
	}

	public PredicaoGastos(Long valor_gasto_mesAtual, Long valor_gasto_mes, Long valor_gasto_mes_anterior,
			Long valor_recebido_mes_anterior, Long valor_gasto_mes2, Long valor_gasto_mes3, Long valor_gasto_mes4,
			Long valor_gasto_mes5, Long valor_gasto_mes6, Long valor_recebido_mes2, Long valor_recebido_mes3) {
		super();
		this.valor_gasto_mesAtual = valor_gasto_mesAtual;
		this.valor_gasto_mes = valor_gasto_mes;
		this.valor_gasto_mes_anterior = valor_gasto_mes_anterior;
		this.valor_recebido_mes_anterior = valor_recebido_mes_anterior;
		this.valor_gasto_mes2 = valor_gasto_mes2;
	...
	public void setValor_gasto_mesAtual(Long valor_gasto_mesAtual) {
		this.valor_gasto_mesAtual = valor_gasto_mesAtual;
	}
	...
	public String toString() {
		return valor_recebido_mes_anterior + ";" + valor_recebido_mes2 + ";" + valor_recebido_mes3 + ";"
				+ valor_gasto_mes6 + ";" + valor_gasto_mes5 + ";" + valor_gasto_mes4 + ";" + valor_gasto_mes3 + ";"
				+ valor_gasto_mes2 + ";" + valor_gasto_mes_anterior + ";" + valor_gasto_mes + ";" + valor_gasto_mesAtual;
	}
